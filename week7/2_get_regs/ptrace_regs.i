# 1 "ptrace_regs.c"
# 1 "/home/janna/Jannas/OS/week7/2_get_regs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
# 26 "/usr/include/x86_64-linux-gnu/sys/ptrace.h" 3 4
...
# 26 "/usr/include/x86_64-linux-gnu/bits/ptrace-shared.h" 3 4
...
# 132 "/usr/include/x86_64-linux-gnu/bits/ptrace-shared.h" 3 4
extern long int ptrace (enum __ptrace_request __request, ...) __attribute__ ((__nothrow__ , __leaf__));
# 199 "/usr/include/x86_64-linux-gnu/sys/ptrace.h" 2 3 4


# 4 "ptrace_regs.c" 2
# 1 "/usr/include/x86_64-linux-gnu/sys/reg.h" 1 3 4
# 5 "ptrace_regs.c" 2
...
# 27 "ptrace_regs.c"
        ...
        break;
      orig_rax = ptrace(PTRACE_PEEKUSER, child, 8 * 
# 29 "ptrace_regs.c" 3 4
                                                   15
# 29 "ptrace_regs.c"
                                                           , 
# 29 "ptrace_regs.c" 3 4
...
# 33 "ptrace_regs.c"
          ...
          rax = ptrace(PTRACE_PEEKUSER, child, 8 * 
# 38 "ptrace_regs.c" 3 4
                                                  10
# 38 "ptrace_regs.c"
                                                     , 
# 38 "ptrace_regs.c" 3 4
